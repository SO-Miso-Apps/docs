...
### Fixing Inconsistent Tags After Campaigns

**Problem:** Staff entered inconsistent tags like `sale-off` (lowercase) and `Sale-Off` (capitalized) during a promotion. You want to standardize them.

**Solution:**
  * Click **Start Deep Scan** to scan your entire store.
  * The tool will detect duplicate tags with different casing.
  * Select the duplicates and click **Merge** to combine them into a single standard tag.

---

## FAQ

**What does the "Data Cleaner" detect?**
