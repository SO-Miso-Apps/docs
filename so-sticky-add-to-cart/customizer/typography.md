---
title: Typography
description: Customize fonts, sizes, and weights for optimal readability.
sidebar_position: 5
---
...
**Size hierarchy:**
Price > Product Name > Button Text
...
**Weight hierarchy:**
Price (Bold) > Button (Semi-Bold) > Product Name (Medium)
...
- [Spacing](./spacing.md) - Adjust layout and padding
- [Colors](./colors.md) - Set your color palette
- [Presets](./presets.md) - Try pre-configured typography
